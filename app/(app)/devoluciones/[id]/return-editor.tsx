...
export default function ReturnEditor({movement,lines,evidence,products,role}:{movement:ReturnMovement;lines:ReturnLine[];evidence:Evidence[];products:ReturnProduct[];role:AppRole}){
  ...
  const pickerStyle={display:'flex',alignItems:'center',justifyContent:'center',gap:6,minHeight:46,padding:'10px 12px',borderRadius:10,background:'#eaf3ff',color:'#0868d9',fontWeight:800,fontSize:13,cursor:'pointer',textAlign:'center' as const,width:'100%'};
